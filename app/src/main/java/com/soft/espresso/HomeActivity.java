...
import com.soft.espresso.fragment.FragmentAboutus;
import com.soft.espresso.fragment.FragmentDrawer;
import com.soft.espresso.fragment.FragmentUserList;
...
public class HomeActivity extends AppCompatActivity implements View.OnClickListener, FragmentDrawer.FragmentDrawerListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.action_aboutus){
            Toast.makeText(getApplicationContext(), "aboutus action is selected!", Toast.LENGTH_SHORT).show();
            return true;
        }
